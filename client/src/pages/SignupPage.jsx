  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-[#030712] text-slate-100 overflow-hidden font-sans select-none">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-25 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="signup-grid" width="50" height="50" patternUnits="userSpaceOnUse">
          ...
          <radialGradient id="signup-fade-grad" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="white" stopOpacity="1" />
            <stop offset="100%" stopColor="white" stopOpacity="0" />
          </radialGradient>
          <mask id="signup-grid-mask">
            <rect width="100%" height="100%" fill="url(#signup-fade-grad)" />
          </mask>
        </defs>
        <rect width="100%" height="100%" fill="url(#signup-grid)" mask="url(#signup-grid-mask)" />
      </svg>
      ...
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-blue-950/25 rounded-full blur-[125px] pointer-events-none" />
      <div className="absolute bottom-1/3 right-1/4 w-[380px] h-[380px] bg-emerald-950/15 rounded-full blur-[110px] pointer-events-none animate-pulse" style={{ animationDuration: '10s' }} />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-40 select-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl shadow-[0_0_80px_rgba(6,182,212,0.3)] animate-pulse" style={{ animationDuration: '8s' }} />
